...
# 📖 [Test_Unit] <a name="about-project"></a>

**[Test_Unit]** In this exercise, I write a few practical tests for JavaScript functions using the Jest library.
...
Clone this repository to your desired folder:
  ...
  - cd my-folder
  - git clone [here](https://github.com/Kaghenimbale/Unit-test.git)
